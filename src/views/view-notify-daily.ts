...
import { ContextNotifyDaily, Reply, View } from "../interfaces.js";
...
export default class ViewNotifyDaily implements View {
  frontend(context: ContextNotifyDaily): Reply {
      ...
      return {
        ...
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(
              `Reminder was updated to run daily at ${nextPraiseTime}`,
            ),
        ],
      };
    }
    ...
    if (context.enable) {
      ...
      return {
        ...
        embeds: [
          new EmbedBuilder()
            .setColor(Color.MINT)
            .setDescription(
              `Vegito will reminder you daily at ${nextPraiseTime}!`,
            ),
        ],
      };
    } else {
      return {
        embeds: [
          new EmbedBuilder().setColor(Color.APRICOT).setDescription(oneLine`
